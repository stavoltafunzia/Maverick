...
namespace Splines {
	...
	SplineSet::SplineSet(string const &name)
					: _name(name), baseValue(name + "_values"), basePointer(name + "_pointers"), _npts(0), _nspl(0), _X(nullptr),
						_Y(nullptr), _Yp(nullptr), _Ypp(nullptr), _Ymin(nullptr), _Ymax(nullptr)
//  , lastInterval(0)
	{}
