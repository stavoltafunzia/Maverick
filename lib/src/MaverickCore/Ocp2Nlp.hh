...
namespace Maverick {
  ...
  public:
    ...
    virtual integer
    getNlpTargetGradientPattern(integer col_index[], integer const col_offset, integer const length) const;
    ...
    virtual integer getNlpConstraintsJacobianPattern(integer row_index[], integer col_index[], integer const row_offset,
    ...
    virtual integer
    getNlpHessianPattern(integer row_index[], integer col_index[], integer const row_offset, integer const col_offset,
    ...
    virtual threads_affinity getActualThreadsAffinityUsed(integer const i_phase) const = 0;
