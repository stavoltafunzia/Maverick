...
namespace MaverickUtils {
  ...
  public:
    ...
    inline real funcEval_D_1(real const x1) const {
      return _y_scale * _x_scale_inv * unscaledFuncEval_D_1(x1 * _x_scale_inv);
    }

    inline real funcEval_D_1_1(real const x1) const {
      return _y_scale * _x_scale_inv * _x_scale_inv * unscaledFuncEval_D_1_1(x1 * _x_scale_inv);
    }

    inline real funcEval_D_1_1_1(real const x1) const {
      return _y_scale * _x_scale_inv * _x_scale_inv * _x_scale_inv * unscaledFuncEval_D_1_1_1(x1 * _x_scale_inv);
    }
