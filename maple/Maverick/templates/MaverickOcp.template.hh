#ifndef _MAVERICK_ENTER_CLASS_NAME_HH
#define _MAVERICK_ENTER_CLASS_NAME_HH

#include "MaverickCore/Maverick.hh"
_MAVERICK_ENTER_EXT_OBJ_INCLUDES

#define NUM_MODEL_PARAMS _MAVERICK_ENTER_NUM_MODEL_PARAMS
_MAVERICK_ENTER_PARAMS_INDEX_DEFINES

namespace _MAVERICK_ENTER_CLASS_NAMENamespace {

    using namespace Maverick;

    class _MAVERICK_ENTER_CLASS_NAME : public MaverickOcp {

    public:

        _MAVERICK_ENTER_CLASS_NAME();
        ...
        //external objects
_MAVERICK_ENTER_EXT_OBJECTS_DEFINITIONS
