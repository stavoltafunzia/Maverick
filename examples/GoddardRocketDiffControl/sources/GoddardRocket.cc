...
GoddardRocket::GoddardRocket() {
    ...
    _post_processing_names = {  {"t", "thrust"} };
    _differential_post_processing_names = {  {} };
    _integral_post_processing_names = {  {"t2"} };

    _model_params = new real[NUM_MODEL_PARAMS]; // deleted automatically by parent's destructor
    _model_params_names = {"Vmin", "Vmax", "Vi", "Vguess", "hmin", "hmax", "hi", "mmin", "mmax", "mi", "mguess", "Tmin", "Tmax", "Tguess", "Fmin", "Fmax", "h0", "sigma", "c", "g", "wl1", "wl2", "wm", "wlt"};
...
integer GoddardRocket::getStatesControlsBounds(integer const i_phase,
    ...
    lower[3] = _model_params[MOD_PAR_INDEX_Fmin];
    }
    ...
    upper[3] = _model_params[MOD_PAR_INDEX_Fmax];
    }
...
//   +--------------------------------------------+
 ...
 integer GoddardRocket::lagrange ( integer const i_phase,
                           ...
                           real          __zeta,
                           real        & __value ) const {
       real t5 = pow(__states_controls[3], 0.2e1);
    real t10 = pow(__state_control_derivatives[3], 0.2e1);
    __value = __parameters[0] * (_model_params[MOD_PAR_INDEX_wl2] * t10 + _model_params[MOD_PAR_INDEX_wl1] * t5 - _model_params[MOD_PAR_INDEX_wlt] * __states_controls[0]);
 ...
 integer GoddardRocket::lagrangeJac ( integer const i_phase,
    ...
    real t8 =  __states_controls[3];
    __jac_xu[1] = 2 * t1 * t6 * t8;
    real t11 =  _model_params[MOD_PAR_INDEX_wl2];
    real t13 =  __state_control_derivatives[3];
    __jac_dxu[0] = 2 * t1 * t11 * t13;
    real t15 = t8 * t8;
    real t17 = t13 * t13;
    __jac_p[0] = t11 * t17 + t6 * t15 - t3 * __states_controls[0];
...
void GoddardRocket::lagrangeJacPPattern ( integer const i_phase, integer cols[] ) const {
 ...
 integer GoddardRocket::lagrangeHess ( integer const i_phase,
    ...
    __hess_xu_xu[0] = 2 * t1 * t3 * __lambda_0;
    __hess_xu_p[0] = -_model_params[MOD_PAR_INDEX_wlt] * __lambda_0;
    __hess_xu_p[1] = 2 * t3 * __states_controls[3] * __lambda_0;
    real t13 = _model_params[MOD_PAR_INDEX_wl2];
    __hess_dxu_dxu[0] = 2 * t1 * t13 * __lambda_0;
    __hess_dxu_p[0] = 2 * t13 * __state_control_derivatives[3] * __lambda_0;
...
integer GoddardRocket::foEqnsJac (integer const i_phase,
    ...
    real t23 = t11 * t11;
    __jac_xu[3] = (-t16 * t10 + __states_controls[3]) / t23;
    __jac_xu[4] = -t12;
    __jac_xu[5] = 0.1e1 / _model_params[MOD_PAR_INDEX_c];
    real t27 = __parameters[0];
    __jac_dxu[0] = 0.1e1 / t27;
...
integer GoddardRocket::foEqnsHess(integer const i_phase,
    ...
    __hess_xu_xu[8] = -0.2e1 * t1 * (-t3 * t27 * t10 + __states_controls[3]) / t22 / t11;
    __hess_xu_xu[9] = t1 * t23;
    __hess_xu_xu[10] = __hess_xu_xu[9];
...
void GoddardRocket::postProcessing(integer const i_phase,
    ...
    __values[1] = __states_controls[3];
