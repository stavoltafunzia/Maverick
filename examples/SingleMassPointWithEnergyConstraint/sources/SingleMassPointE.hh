...
#define MOD_PAR_INDEX_Emin 14
#define MOD_PAR_INDEX_Emax 15


namespace SingleMassPointENamespace {

    using namespace Maverick;

    class SingleMassPointE : public MaverickOcp {
