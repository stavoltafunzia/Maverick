...
namespace Maverick {
    ...
    MidpointIntegrator::MidpointIntegrator(MaverickOcp const & ocp_problem, OcpScaling const & ocp_scaling, integer const i_phase, EquationIntegratorType integrator_type): _ocp(ocp_problem), _scaling(ocp_scaling), _i_phase(i_phase) {
        ...
        if (integrator_type == integrator_tensolve)
    ...
    MidpointIntegrator::~MidpointIntegrator() {
        ...
        std::vector<real *> to_delete_real = {_p_scaling_y, _p_inv_scaling_y, _p_scaling_ay, _p_inv_scaling_ay,
            _p_c_xu_left_ns, _p_c_xu_right_ns, _p_c_axu_ns, _p_p_ns, _p_c_xu_center_ns, _p_c_xu_diff_ns,
            _p_inv_scaling_fo_eqns, _p_scale_factor_jac, _p_scale_factor_jac_dense, _p_scale_factor_hess
        };
        ...
        std::vector<integer *> to_delete_int = { _p_j_xu_outer_starts, _p_j_dxu_outer_starts, _p_j_axu_outer_starts,
            ...
            _p_h_xu_xu_outer_starts, _p_h_xu_dxu_outer_starts, _p_h_xu_axu_outer_starts, _p_h_dxu_dxu_outer_starts, _p_h_dxu_axu_outer_starts, _p_h_axu_axu_outer_starts,
            _p_h_xu_xu_rows, _p_h_xu_dxu_rows, _p_h_xu_axu_rows, _p_h_dxu_dxu_rows, _p_h_dxu_axu_rows, _p_h_axu_axu_rows,
    ...
    void MidpointIntegrator::initializeMatrixes() {
      ...
      //HESSIAN
      {
...

          {
              ...
              hess.block(0,0,_dim_x,_dim_x) = hess_xu_xu.block(0,0,_dim_x,_dim_x) + hess_xu_dxu.block(0,0,_dim_x,_dim_x) + hess_dxu_dxu.block(0,0,_dim_x,_dim_x);
              hess.block(_dim_x,_dim_x,_dim_ax,_dim_ax) = hess_axu_axu.block(0,0,_dim_ax,_dim_ax);
              hess.block(_dim_x,0,_dim_ax,_dim_x) = hess_xu_axu.block(0,0,_dim_ax,_dim_x) + hess_dxu_axu.block(0,0,_dim_ax,_dim_x);
    ...
    void MidpointIntegrator::loadIpoptEquationSolver() {
        ...
        typedef std::unique_ptr<Maverick::EquationSolverInterface> (*GetIpoptEquationSolver)(EquationSolverSupplierInterface const &);
    ...
    void MidpointIntegrator::loadTensolveEquationSolver() {
        ...
        typedef std::unique_ptr<Maverick::EquationSolverInterface> (*GetTensolveEquationSolver)(EquationSolverSupplierInterface const &);
    ...
    void MidpointIntegrator::evalEquationsSparseJac (bool const new_unk,
        ...
        _ocp.foEqnsJac(_i_phase, _p_c_xu_center_ns, _p_c_xu_diff_ns, _p_c_axu_ns, _p_p_ns, _zeta_center, grad_xu, grad_dxu, grad_axu, grad_p);
        ...
        multiplyAndCopyVectorTo(grad_ax.valuePtr(), grad + grad_x_nnz, _p_scale_factor_jac + grad_x_nnz, (integer) grad_ax.nonZeros());
    }

    void MidpointIntegrator::evalEquationsDenseJac (bool const new_unk,
                                                   integer const n_unk, real const unk[],
                                                   real grad[]) const  {
        MAVERICK_DEBUG_ASSERT(_dim_x + _dim_ax == _dim_unk, "MidpointIntegrator::evalEquationsDenseJac: wrong unknown size\n");
        if (new_unk)
            writeStateScaled(unk, unk + _dim_x);
        ...
        result.block(0, 0, _dim_eq, _dim_x) = grad_xu_mat.block(0,0,_dim_eq,_dim_x) * 0.5 + grad_dxu_mat.block(0,0,_dim_eq,_dim_x) * _d_zeta_inv;
    ...
    void MidpointIntegrator::evalEquationsDenseHess (bool const new_unk,
...

        {
            ...
            _ocp.foEqnsHess(_i_phase, _p_c_xu_center_ns, _p_c_xu_diff_ns, _p_c_axu_ns, _p_p_ns, _zeta_center, lambda_scaled,
                             hess_xu_xu, hess_dxu_dxu, hess_xu_axu, hess_xu_p, hess_dxu_dxu, hess_dxu_axu, hess_dxu_p, hess_axu_axu, hess_axu_p, hess_p_p);
        }
        ...
        result.block(_dim_x,0,_dim_ax,_dim_x) = hess_xu_axu_mat.block(0,0,_dim_ax,_dim_x)*0.5 + hess_dxu_axu_mat.block(0,0,_dim_ax,_dim_x) * _d_zeta_inv;
