...
void MidpointOcp2NlpSinglePhase::calculateNlpConstraintsBetweenMeshPoints(integer const first_mesh_point, integer const last_mesh_point,
    ...
    try {
        ...
        for (integer current_mesh_interval = first_mesh_point; current_mesh_interval < last_mesh_point; current_mesh_interval++) {
            ...
            computeTpzDerivative(p_left_state_control_scaled, p_right_state_control_scaled, _p_scaling_y, ocp_state_control_derivative, 1/d_zeta, _dim_xu);
