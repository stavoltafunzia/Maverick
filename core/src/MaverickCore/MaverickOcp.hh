...
namespace Maverick {
    ...
    public:
        ...
        virtual void translateSolutionHeader( std::stringstream const & input_header, integer const i_phase, std::ostream & output ) const;

        // mesh history
        virtual void writeMeshHistoryToFile(SolverOutput const & solver_output, std::string const & filename) const;
