...
extern "C" {
    ...
    /* create a MaverickSolver object binded to the MaverickOcp object with the provided ID.
    ...
    /* delete the MaverickSolver object with the provided ID.
       Error codes are: 0 = succsefull
                        1 = null pointer
     */
    void   deleteMaverickSolver(void * const p_solver, int * const p_err_code);
