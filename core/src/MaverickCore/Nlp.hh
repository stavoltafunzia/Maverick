...
namespace Maverick {
    ...
    public:
        ...
        void setNlp(size const n_y, real const y[], real const upper_bounds_multipliers[], real const lower_bounds_multipliers[],
...
//        void setLagrangeMayerPercentage( real const lagrange_mayer_percentage );
...
//        real getLagrangeMayerPercentage() const { return _lagrange_mayer_percentage; }
    ...
    protected:
        ...
        real _lagrange_mayer_percentage;
