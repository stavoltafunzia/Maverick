...
namespace MaverickUtils {
    ...
    protected:
        ...
        real findValueParamWithPrefixAndName(std::string const &prefix, std::string const & name, GC::GenericContainer const & gc) const;

        std::string findStringParamWithPrefixAndName(std::string const &prefix, std::string const & name, GC::GenericContainer const & gc) const;

        integer findIntParamWithPrefixAndName(std::string const & prefix, std::string const & name, GC::GenericContainer const & gc) const;

        vec_1d_real findVectorParamWithPrefixAndName(std::string const & prefix, std::string const & name, GC::GenericContainer const & gc) const;
        ...
        real findValueParamWithPrefixAndName(std::string const &prefix, std::string const &name1, std::string const &name2, GC::GenericContainer const &gc) const;
        ...
        real findValueParamWithNameAndInverseNameAndDefValue(std::string const & name1, std::string const & name2, real const defValue, GC::GenericContainer const &gc) const;
