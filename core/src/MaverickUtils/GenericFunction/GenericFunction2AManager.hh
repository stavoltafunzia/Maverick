...
namespace MaverickUtils {
	...
	public:
        ...
        inline virtual real funcEval_D_1_1(real const x1, real const x2) const { return _p_function->funcEval_D_1_1(x1, x2); }
        inline virtual real funcEval_D_1_2(real const x1, real const x2) const { return _p_function->funcEval_D_1_2(x1, x2); }
        inline virtual real funcEval_D_2_2(real const x1, real const x2) const { return _p_function->funcEval_D_2_2(x1, x2); }
        
        virtual void printInfo( std::ostream & out, InfoLevel info_level ) const { ComponentManagerBase::printInfo(out, info_level); }
