...
namespace MaverickUtils {
	...
	public:
        ...
        inline real funcEval(real const x1, real const x2) const       { return _y_scale *                                 unscaledFuncEval      (x1 * _x1_scale_inv, x2 * _x2_scale_inv); }
        inline real funcEval_D_1(real const x1, real const x2) const   { return _y_scale * _x1_scale_inv *                 unscaledFuncEval_D_1  (x1 * _x1_scale_inv, x2 * _x2_scale_inv); }
        inline real funcEval_D_2(real const x1, real const x2) const   { return _y_scale * _x2_scale_inv *                 unscaledFuncEval_D_2  (x1 * _x1_scale_inv, x2 * _x2_scale_inv); }
        inline real funcEval_D_1_1(real const x1, real const x2) const { return _y_scale * _x1_scale_inv * _x1_scale_inv * unscaledFuncEval_D_1_1(x1 * _x1_scale_inv, x2 * _x2_scale_inv); }
        inline real funcEval_D_1_2(real const x1, real const x2) const { return _y_scale * _x1_scale_inv * _x2_scale_inv * unscaledFuncEval_D_1_2(x1 * _x1_scale_inv, x2 * _x2_scale_inv); }
        inline real funcEval_D_2_2(real const x1, real const x2) const { return _y_scale * _x2_scale_inv * _x2_scale_inv * unscaledFuncEval_D_2_2(x1 * _x1_scale_inv, x2 * _x2_scale_inv); }
